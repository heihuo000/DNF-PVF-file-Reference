...
| 👤 **CHR角色知识库** | 角色文件(.chr)完整指南 | ⭐⭐⭐ | ✅ 完整 | [进入](CHR文件知识库/README.md) |
| 🗺️ **MAP地图知识库** | 地图文件(.map)指南 | ⭐⭐⭐⭐ | ✅ 完整 | [进入](MAP文件知识库/README.md) |
| 👹 **MOB怪物知识库** | 怪物文件(.mob)指南 | ⭐⭐⭐⭐ | ✅ 完整 | [进入](MOB文件知识库/README.md) |
| ⚡ **技能文件知识库** | 技能文件(.skl)指南 | ⭐⭐⭐⭐⭐ | ✅ 完整 | [进入](技能文件知识库/README.md) |
...
2. **🎯 选择文件类型**
   ...
   - 制作角色 → [CHR角色知识库](CHR文件知识库/README.md)
   - 制作地图 → [MAP地图知识库](MAP文件知识库/README.md)
   - 制作怪物 → [MOB怪物知识库](MOB文件知识库/README.md)
   - 制作技能 → [技能文件知识库](技能文件知识库/README.md)
...
| 功能类别 | 装备相关 | 物品相关 | 商店相关 | 角色相关 | 地图相关 | 怪物相关 | 技能相关 |
|----------|----------|----------|----------|----------|----------|----------|----------|
| **基础属性** | [装备属性标签](DNF装备文件知识库/02-属性标签/) | [基础STK类型](STK文件知识库/01-基础STK类型/) | [基础信息标签](SHO文件知识库/01-基础信息标签/) | [基础信息](CHR文件知识库/01-基础信息/) | [标签参考](MAP文件知识库/标签参考.md) | [标签参考](MOB文件知识库/标签参考.md) | [标签参考](技能文件知识库/标签参考.md) |
| **特殊效果** | [特殊效果标签](DNF装备文件知识库/03-特殊效果标签/) | [高级STK类型](STK文件知识库/02-高级STK类型/) | [商店配置标签](SHO文件知识库/02-商店配置标签/) | [属性标签](CHR文件知识库/02-属性标签/) | [实际案例](MAP文件知识库/实际案例/) | [实际案例](MOB文件知识库/实际案例/) | [示例文件](技能文件知识库/示例文件/) |
| **视觉效果** | [视觉音效标签](DNF装备文件知识库/04-视觉音效标签/) | - | [商品配置标签](SHO文件知识库/03-商品配置标签/) | [动画标签](CHR文件知识库/03-动画标签/) | [模板文件](MAP文件知识库/模板文件/) | [模板文件](MOB文件知识库/模板文件/) | [职业技能参考](技能文件知识库/职业技能参考/) |
...
| **⭐⭐⭐** | [STK物品知识库](STK文件知识库/README.md) | [DNF装备知识库](DNF装备文件知识库/README.md), [CHR角色知识库](CHR文件知识库/README.md) | - |
| **⭐⭐⭐⭐** | - | [MAP地图知识库](MAP文件知识库/README.md), [MOB怪物知识库](MOB文件知识库/README.md) | - |
...
### 更新状态
- **✅ 完整**: DNF装备知识库, STK物品知识库, SHO商店知识库, CHR角色知识库, MAP地图知识库, MOB怪物知识库, 技能文件知识库
- **🔄 持续更新**: 格式规范, 工具优化, 内容完善
